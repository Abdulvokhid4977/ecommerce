          ...
          BlocBuilder<SearchBloc, SearchState>(
              ...
              builder: (context, state) {
                ...
                if (state is SearchLoading) {
                        ...
                        itemBuilder: (ctx, i) {
                          ...
                          return Column(
                            children: [
                              ...
                              if (subcategories.isNotEmpty)
                               CategoryAnimation(category, expandedCategoryId, subcategories),
                            ],
                          );
                        },
                  ...
                  return Expanded(child: SearchList(state.products.product, state.category.category, textEditingController, focus1));
                }
                  ...
                  if (state.product.product.isNotEmpty) {
