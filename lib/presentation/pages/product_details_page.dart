                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            AppUtils.kHeight10,
                            Text(
                              'Экран: 6.8 Дюйма / 120 Гц\nПамять 256GB\nПроцессор: 8ми ядерный - Snapdragon 8 Gen 1\nКамеры: 108 МП + 12 МП + 10 МП + 10МП 10х Zoom\nПередняя камера 40Mp!\nОЗУ- 12GB\nСканер Отпечатка в Экране\nFace iD\nДинамики Стерео Dolby Digital\nAndroid 13.\nСтандарты связи: GSM/HSUPA/5G/4G/3G и Т.Д.\nАккумулятор 5000mah',
                              style: GoogleFonts.inter(
...
//                         Row(
//                           children: [
//                             Text('Цвет: ', style: GoogleFonts.inter(
//                               fontWeight: FontWeight.w500, color: Colours.greyIcon,
//                               fontSize: 18,
//                             ),),
//                             Text(
//                               _itemColor[1]['color'],
