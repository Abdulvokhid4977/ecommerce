  ...
  Future<bool> _updateFavorite(
    ...
    final response = await http.put(
      ...
      body: jsonEncode({
        ...
        "product_categoty": event.productElement.productCategoty,
        ...
        "created_at": event.productElement.createdAt,
  ...
  Future<void> _fetchData(FetchDataEvent event, Emitter<MainState> emit) async {
    ...
    try {
      ...
      if (responses[0].statusCode == 200 &&
        ...
        result3 = ctg.Category.fromJson(jsonDecode(responses[2].body));
